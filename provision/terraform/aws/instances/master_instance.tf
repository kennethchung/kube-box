...
// resource "aws_network_interface" "kubebox_master" {
...
resource "aws_instance" "kubebox_master" {
  ...
  // network_interface {
  //    network_interface_id       = "${aws_network_interface.kubebox_master.id}"
  //    device_index               = 0
  // } 
  tags {
...
// output "network_interface_id1_id" {
//   value       = "${aws_network_interface.kubebox_master.id}"
// }

// output "network_interface_id1_private_ips" {
//   value       = "${aws_network_interface.kubebox_master.private_ips }"
// }


// output "network_interface_id1_private_ips_count" {
//   value       =  "${length(aws_network_interface.kubebox_master.private_ips)}"  
// }
